...
from customerbase.forms import *
...
def search(request):
    if request.method == 'POST':
        ...
        searched = Q(Q(name__icontains=items)| Q(model__icontains=items)| Q(year__icontains=items)| Q(price__icontains=items))
